...
See `eldoc-documentation-strategy' for more detail.") (register-definition-prefixes "eldoc" '("eldoc")) (provide 'eldoc-autoloads)) "lsp-mode" ((lsp-purescript lsp-trunk lsp-kotlin lsp-nix lsp-autotools lsp-rubocop lsp-d lsp-awk lsp-dot lsp-perl lsp-sql lsp-vimscript lsp-qml lsp-ansible lsp-vhdl lsp-glsl lsp-lisp lsp-sml lsp-asm lsp-nushell lsp-mojo lsp-nginx lsp-pls lsp-clangd lsp-pylsp lsp-emmet lsp-nim lsp-vetur lsp-eslint lsp-cobol lsp-modeline lsp-protocol lsp-semantic-tokens lsp-cmake lsp-rpm-spec lsp-astro lsp-copilot lsp-idris lsp-ocaml lsp-lua lsp-credo lsp-meson lsp-jq lsp-actionscript lsp-wgsl lsp lsp-yaml lsp-jsonnet lsp-csharp lsp-elixir lsp-futhark lsp-mint lsp-json lsp-terraform lsp-tilt lsp-crystal lsp-camel lsp-cucumber lsp-magik lsp-angular lsp-roslyn lsp-yang lsp-icons lsp-ruby-lsp lsp-bash lsp-sorbet lsp-sqls lsp-lens lsp-clojure lsp-erlang lsp-gdscript lsp-svelte lsp-openscad lsp-typeprof lsp-iedit lsp-ruby-syntax-tree lsp-fennel lsp-ido lsp-tex lsp-mdx lsp-semgrep lsp-solargraph lsp-go lsp-beancount lsp-javascript lsp-steep lsp-dhall lsp-fortran lsp-css lsp-markdown lsp-mode lsp-toml lsp-dired lsp-hy lsp-verilog lsp-dockerfile lsp-zig lsp-solidity lsp-groovy lsp-pyls lsp-hack lsp-typespec lsp-earthly lsp-mode-autoloads lsp-headerline lsp-move lsp-haxe lsp-marksman lsp-v lsp-graphql lsp-volar lsp-fsharp lsp-inline-completion lsp-php lsp-racket lsp-diagnostics lsp-html lsp-pwsh lsp-nextflow lsp-gleam lsp-ada lsp-ttcn3 lsp-xml lsp-golangci-lint lsp-cypher lsp-vala lsp-rf lsp-ruff lsp-prolog lsp-r lsp-rust lsp-bufls lsp-elm lsp-perlnavigator lsp-remark lsp-completion) (register-definition-prefixes "lsp-actionscript" '("lsp-actionscript-")) (put 'lsp-ada-project-file 'safe-local-variable 'stringp) (register-definition-prefixes "lsp-ada" '("lsp-ada-")) (register-definition-prefixes "lsp-angular" '("lsp-client")) (register-definition-prefixes "lsp-ansible" '("lsp-ansible-")) (register-definition-prefixes "lsp-asm" '("lsp-asm-")) (register-definition-prefixes "lsp-astro" '("lsp-astro--get-initialization-options")) (register-definition-prefixes "lsp-autotools" '("lsp-autotools-")) (register-definition-prefixes "lsp-awk" '("lsp-awk-executable")) (register-definition-prefixes "lsp-bash" '("lsp-bash-")) (register-definition-prefixes "lsp-beancount" '("lsp-beancount-")) (register-definition-prefixes "lsp-bufls" '("lsp-buf")) (register-definition-prefixes "lsp-camel" '("lsp-camel-")) (autoload 'lsp-cpp-flycheck-clang-tidy-error-explainer "lsp-clangd" "Explain a clang-tidy ERROR by scraping documentation from llvm.org.
...
(fn &optional ARG)" t) (register-definition-prefixes "counsel" '("counsel-" "ivy-function-called-at-point")) (provide 'counsel-autoloads)) "ivy-rich" ((ivy-rich ivy-rich-autoloads) (defvar ivy-rich-mode nil "Non-nil if Ivy-Rich mode is enabled.
